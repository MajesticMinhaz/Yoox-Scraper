    ...
    for product in all_data:
        ...
        for _ in product.get('Handle'):
            row = row_data_creator(
                product.get('Handle')[index],
                product.get('Title')[index],
                product.get('Body (HTML)')[index],
                product.get('Vendor')[index],
                product.get('Standardized Product Type')[index],
                product.get('Custom Product Type')[index],
                product.get('Tags')[index],
                product.get('Published')[index],
                product.get('ID')[index],
                product.get('Option1 Name')[index],
                product.get('Option1 Value')[index],
                product.get('Option2 Name')[index],
                product.get('Option2 Value')[index],
                product.get('Option3 Name')[index],
                product.get('Option3 Value')[index],
                product.get('Variant SKU')[index],
                product.get('Variant Grams')[index],
                product.get('Variant Inventory Tracker')[index],
                product.get('Variant Inventory Qty')[index],
                product.get('Variant Inventory Policy')[index],
                product.get('Variant Fulfillment Service')[index],
                product.get('Variant Price')[index],
                product.get('Variant Compare At Price')[index],
                product.get('Variant Requires Shipping')[index],
                product.get('Variant Taxable')[index],
                product.get('Variant Barcode')[index],
                product.get('Image Src')[index],
                product.get('Image Position')[index],
                product.get('Image Alt Text')[index],
                product.get('Gift Card')[index],
                product.get('SEO Title')[index],
                product.get('SEO Description')[index],
                product.get('Google Shopping / Google Product Category')[index],
                product.get('Google Shopping / Gender')[index],
                product.get('Google Shopping / Age Group')[index],
                product.get('Google Shopping / MPN')[index],
                product.get('Google Shopping / AdWords Grouping')[index],
                product.get('Google Shopping / AdWords Labels')[index],
                product.get('Google Shopping / Condition')[index],
                product.get('Google Shopping / Custom Product')[index],
                product.get('Google Shopping / Custom Label 0')[index],
                product.get('Google Shopping / Custom Label 1')[index],
                product.get('Google Shopping / Custom Label 2')[index],
                product.get('Google Shopping / Custom Label 3')[index],
                product.get('Google Shopping / Custom Label 4')[index],
                product.get('Variant Image')[index],
                product.get('Variant Weight Unit')[index],
                product.get('Variant Tax Code')[index],
                product.get('Cost per item')[index],
                product.get('Status')[index]
            )
